...
class LineTraceSaver {
	...
	GetMarkPosition(e, t) {
		...
		this.uoe || this.InitTrackInfo(),
			this.uoe.SetStartLocation(100 * e, 100 * t, 1e6),
			this.uoe.SetEndLocation(100 * e, 100 * t, -1e6);
		var r = TraceElementCommon_1.TraceElementCommon.LineTrace(
				this.uoe,
				PROFILE_KEY,
			),
		...
		return (
			r &&
				o.bBlockingHit &&
				((r = o.LocationZ_Array.Get(0)),
				(r /= 100),
				(a = Vector_1.Vector.Create(e, t, r))),
...
class MapController extends ControllerWithAssistantBase_1.ControllerWithAssistantBase {
	...
	static RequestRemoveMapMarks(e, t) {
		var a = ModelManager_1.ModelManager.MapModel.GetCurTrackMark();
		for (const r of t)
			a &&
				a[0] === e &&
				a[1] === r &&
	...
	static RequestTrackMapMark(e, t, a) {
		a
			? (void 0 ===
					(a = ModelManager_1.ModelManager.MapModel.GetCurTrackMark()) ||
					(a[0] === e && a[1] === t) ||
					MapController.cYt(0).RequestCancelTrackMapMark(a[0], a[1]),
	...
	static ForceSetMarkVisible(e, t, a) {
		ModelManager_1.ModelManager.MapModel.ForceSetMarkVisible(e, t, a),
	...
	static OpenMapViewAndFocusMark(e, t, a, r = !0, o = 1) {
		MapController.cYt(0).OpenMapViewAndFocus(e, t, a, r, o);
	}
}
