	...
	function (t, e, n, r) {
		...
		if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
			...
			for (var s = t.length - 1; 0 <= s; s--)
				(i = t[s]) && (o = (a < 3 ? i(o) : 3 < a ? i(e, n, o) : i(e, n)) || o);
...
let RoleStrengthComponent = class extends EntityComponent_1.EntityComponent {
	constructor() {
		super(...arguments),
			(this.Hte = void 0),
			(this.$zo = void 0),
						...
						case CharacterUnifiedStateTypes_1.ECharPositionState.Air:
							...
							return (
								this.HBr.MoveState ===
									...
									(n = this.Entity.GetComponent(51)).Valid &&
									n.ExitGlideState(),
								void this.EmptyStrengthPunish()
							);
