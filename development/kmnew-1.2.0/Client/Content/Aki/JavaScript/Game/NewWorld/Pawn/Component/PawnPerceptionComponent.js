	...
	function (e, t, n, i) {
		...
		if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
			...
			for (var h = e.length - 1; 0 <= h; h--)
				(r = e[h]) && (o = (a < 3 ? r(o) : 3 < a ? r(t, n, o) : r(t, n)) || o);
...
let PawnPerceptionComponent = class extends EntityComponent_1.EntityComponent {
	...
	SetInteractRange(e, t = 0, n = void 0) {
		this.rzr.SetLogicRange(Math.max(e + 100, t)),
			this.Ihn
				? this.Ihn.UpdateDistance(e, 0 === t ? e : t)
	...
	SetSightRange(e) {
		this.rzr.SetLogicRange(e),
			this.Thn
				? this.Thn.UpdateDistance(e)
	...
	SetGuideRange(e) {
		this.rzr.SetLogicRange(e),
			this.Lhn
				? this.Lhn.UpdateDistance(e)
				: ((this.Lhn = this.rzr.CreatePerceptionEvent()),
					this.Lhn.Init(e, this.Entity?.GameBudgetManagedToken, () => {
						EventSystem_1.EventSystem.Emit(
	...
	OnActivate() {
		var e,
			t,
			n = this.Entity.GetComponent(146);
		return (
			n &&
				((e = n.ShowRange),
				(t = n.HideRange),
	...
	GetDebugString() {
		let e = "";
		return (
			(e += `InteractRangeToken: ${this.Ihn?.EventToken ?? "undefined"}; IsInRangeInternal: ${this.vhn}\nInteractRangeInfo:\n`),
			this.Ihn &&
