...
let SceneItemHitComponent = (SceneItemHitComponent_1 = class extends (
	...
	Pfn(t) {
		...
		let e = !0;
		if (0 < this.Tfn.length) for (const i of this.Tfn) if (!(e &&= i(t))) break;
		return e;
	}
	xfn(t, e) {
		if (((t = this.Lfn.get(t)?.ComponentHitConditionCheck), void 0 === t))
			return !0;
		let i = !0;
	...
	Bfn(t, e) {
		...
		if (i) {
			...
			n && 0 < n
				...
				: ((e = (n = EntitySystem_1.EntitySystem.Get(
						t.BulletEntityId,
					...
					BulletUtil_1.BulletUtil.GetHitRotator(n, this.Hte, this.Afn),
					...
					(o = this.Gfn(e))),
				void 0 !== this.Ufn && (i.RemoveTag(this.Ufn), (this.Ufn = void 0)),
				void 0 !== o && (i.AddTag(o), (this.Ufn = o));
		}
	}
	bfn(t) {
		...
		i.TimeScaleOnAttackIgnoreAttacker
			? 0 < n.时间膨胀时长 &&
				...
				BulletUtil_1.BulletUtil.SetTimeScale(
					...
					n.时间膨胀值 * o,
					n.时间膨胀变化曲线,
					Math.min(n.时间膨胀时长 * a, n.时间膨胀时长 + r),
					1,
				))
			: 0 < n.时间膨胀时长 &&
				...
				StringUtils_1.StringUtils.IsEmpty(e) ||
					((i = ModelManager_1.ModelManager.BulletModel.GetEntityIdByCustomKey(
						t.Attacker.Id,
						e,
						t.BulletId.toString(),
					)) &&
	...
	Ofn(t) {
		...
		t.ReBulletData.Base.ContinuesCollision ||
			((e = this.Entity.GetComponent(109)) &&
				...
				(o = this.Rfn?.ValueRatio ?? 1),
				(a = this.Rfn?.TimeRatio ?? 1),
				(r = this.Rfn?.MaxExtraTime ?? 0),
				0 < n.时间膨胀时长) &&
