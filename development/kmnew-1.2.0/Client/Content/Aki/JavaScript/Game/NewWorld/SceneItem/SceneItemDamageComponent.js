...
let SceneItemDamageComponent = (SceneItemDamageComponent_1 = class extends (
	...
	OnInitData(e) {
		...
		return (
			ModManager_1.ModManager.Settings.AutoMining &&
				(!0 === EntityFilter.isneedDestroy(n)
					...
					: ModUtils_1.ModUtils.KunLog(
							"SceneItemDamageComponent: Not an destroyable entity, skipping...",
						)),
			(this.Qdn = t || 100),
	...
	GetHitPoint() {
		...
		return (
			this.n$t.ActorForwardProxy.Multiply(e.X, n),
			t.AdditionEqual(n),
			this.n$t.ActorRightProxy.Multiply(e.Y, n),
			t.AdditionEqual(n),
			this.n$t.ActorUpProxy.Multiply(e.Z, n),
			t.AdditionEqual(n),
