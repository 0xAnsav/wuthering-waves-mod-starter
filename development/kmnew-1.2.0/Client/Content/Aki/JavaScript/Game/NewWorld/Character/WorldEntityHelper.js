...
const UE = require("ue"),
	...
	CharacterHitComponent_1 = require("./Common/Component/CharacterHitComponent_New"),
...
class WorldEntityHelper {
	...
	static CreateWorldEntity(e) {
		...
		switch (n.HHn) {
			case Protocol_1.Aki.Protocol.wks.Proto_Monster:
				if (((e.Priority = 10), this.GetMonsterComponentRecord(e))) break;
				return;
			case Protocol_1.Aki.Protocol.wks.Proto_Player:
				if (((e.Priority = 7), this.GetRoleComponentRecord(e))) break;
				return;
			case Protocol_1.Aki.Protocol.wks.Proto_Vision:
				if (((e.Priority = 11), this.GetVisionComponentRecord(e))) break;
				return;
			case Protocol_1.Aki.Protocol.wks.Proto_Animal:
				if (((e.Priority = 8), this.GetAnimalComponentRecord(e))) break;
				return;
			case Protocol_1.Aki.Protocol.wks.Proto_Custom:
				if (((e.Priority = 8), this.GetCustomComponentRecord(e))) break;
				return;
			case Protocol_1.Aki.Protocol.wks.Proto_Npc:
				switch (((e.Priority = 9), n.JEs || 0)) {
					case 1:
						this.Hor &&
							((o = CharacterController_1.CharacterController.SpawnEntity(
								this.Hor,
							)),
							(t = this.Hor));
						break;
				...
				if (o) (e.ComponentsKey = t), this.Kor(e);
				else {
			...
			case Protocol_1.Aki.Protocol.wks.Proto_SceneItem:
				if (((e.Priority = 8), this.GetSceneItemComponentRecord(e))) break;
				return;
		}
		if (
			((t = e.ComponentsKey),
			(o = o || CharacterController_1.CharacterController.SpawnEntity(t)))
		) {
			if (
				...
				return;
		} else o = CharacterController_1.CharacterController.CreateEntity(t, e);
		return o;
	}
	static Destroy(e) {
	...
	static GetCustomComponentRecord(e) {
		...
		if (!(o = IEntity_1.componentsByEntityAki[o.EntityType])) return !1;
		if (!e.AddComponent(CreatureDataComponent_1.CreatureDataComponent))
			return !1;
		if (!e.AddComponent(PawnSensoryInfoComponent_1.PawnSensoryInfoComponent))
			return !1;
		...
		for (const m of o)
			switch (m) {
				...
				case "TriggerComponent":
					if (!(t = (0, IComponent_1.getComponent)(n, "TriggerComponent")))
						return !1;
	...
	static GetNpcComponentRecord(e) {
		if (!e.AddComponent(CreatureDataComponent_1.CreatureDataComponent))
			return !1;
		if (
			(n = e.GetPbModelConfig()) &&
			((n = n.EntityType),
			IEntity_1.componentsByEntityAki[n] &&
				(n = e.PbEntityInitData) &&
				n.ComponentsData)
		) {
			var n = (n = e.EntityData).JEs || 0,
				o = this.For.get(n);
			if (!o)
				return (
			...
			for (const n of o)
				if (!e.HasComponent(n) && !e.AddComponent(n)) return !1;
			if (GlobalData_1.GlobalData.IsPlayInEditor) {
				if (
					!e.AddComponent(
						UeComponentTickManageComponent_1.UeComponentTickManageComponent,
	...
	static GetSceneItemComponentRecord(e) {
		var n = e.PbEntityInitData;
		if (
			((e.EnableMovement = !1),
			...
			return !1;
		if (!e.AddComponent(SceneItemActorComponent_1.SceneItemActorComponent))
			return !1;
		if (!e.AddComponent(PawnSensoryInfoComponent_1.PawnSensoryInfoComponent))
			return !1;
		if (!e.AddComponent(PawnInfoManageComponent_1.PawnInfoManageComponent))
			return !1;
		if (!e.AddComponent(LevelTagComponent_1.LevelTagComponent)) return !1;
		if (!e.AddComponent(SceneItemStateComponent_1.SceneItemStateComponent))
			return !1;
		if (
			!e.AddComponent(SceneItemPropertyComponent_1.SceneItemPropertyComponent)
		)
			return !1;
		if (!e.AddComponent(PerformanceComponent_1.PerformanceComponent)) return !1;
		if (
			!e.AddComponent(SceneItemTimeScaleComponent_1.SceneItemTimeScaleComponent)
		)
			return !1;
		if (
			GlobalData_1.GlobalData.IsPlayInEditor &&
			!e.AddComponent(SceneItemDebugComponent_1.SceneItemDebugComponent)
		)
			return !1;
		do {
			var o = n?.ComponentsData;
			if (!n) break;
			if (!o) break;
			var t = e.GetPbModelConfig();
			if (!t) break;
			if (((t = t.EntityType), !(t = IEntity_1.componentsByEntityAki[t])))
				break;
			for (const n of t) {
				var r = o[n];
				if (!r)
				...
				if (!r.Disabled) {
					var m = this.Vor.get(n);
					if (m) {
						for (const n of m)
							if (!e.HasComponent(n)) {
								if (!e.AddComponent(n)) return !1;
								e.SetParam(n, r);
							}
						switch (n) {
		...
		if (!e.AddComponent(PawnPerceptionComponent_1.PawnPerceptionComponent))
			return !1;
		if (!e.AddComponent(InteractItemComponent_1.InteractItemComponent))
			return !1;
		if (
			((C = CreateEntityData_1.CreateEntityData.GetBaseInfo(e)),
			C?.IsShowNameOnHead &&
				!e.HasComponent(PawnHeadInfoComponent_1.PawnHeadInfoComponent) &&
				!e.AddComponent(PawnHeadInfoComponent_1.PawnHeadInfoComponent))
		)
			return !1;
		if (
		...
		if (n) {
			...
			if (
				...
				C?.WeaponId &&
					((o = !0),
					!e.AddComponent(
						AiWeaponMovementComponent_1.AiWeaponMovementComponent,
					)))
			)
				return !1;
			if (o) {
