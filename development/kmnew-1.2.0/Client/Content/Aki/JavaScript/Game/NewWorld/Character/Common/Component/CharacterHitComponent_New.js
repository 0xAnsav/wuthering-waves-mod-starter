...
class OnHitMaterialAction {
	...
	Start(t, e, i, r, o = void 0) {
		(this.WKs = !0),
			(this.OKs = t),
			(this.kKs = CommonDefine_1.MILLIONSECOND_PER_SECOND),
			(this.FKs = e),
			(this.HKs = i),
			(this.PHo = r),
			(this.VKs = !1),
	...
	async spa(t, e, i) {
		var r = new Array(2),
			o = [];
		o.push(this.apa(e, r, 0)),
			i && o.push(this.apa(i, r, 1)),
			await Promise.all(o),
			r[0]
				? t !== this.FFe
					? Log_1.Log.CheckDebug() &&
	...
	S9e(t, e, i = "OnHitMaterialAction 开始播放") {
		Log_1.Log.CheckDebug() &&
			...
			e && (this.rpa = this.GKs.AddMaterialControllerData(e));
	}
	Stop(t = !1) {
		this.vJ &&
			(Log_1.Log.CheckDebug() &&
...
let CharacterHitComponent = (CharacterHitComponent_1 = class extends (
	...
	constructor() {
		super(...arguments),
			...
			(this.RVr = () => {
				var t, e;
				this.DoubleHitInAirEffect.Valid &&
					((e = (t = this.Entity.GetComponent(163)).GetLastUpdateVelocity()),
					this.BVr.Set(
					...
					this.BVr.MultiplyEqual(
						(100 / this.EVr.GetCurrentValue(EAttributeId.Proto_Mass)) *
	...
	kVr(t) {
		for (const e of t) if (this.OVr(e)) return !0;
		return !1;
	}
	NVr() {
		var t,
		...
		i.GetEntityType() !== Protocol_1.Aki.Protocol.wks.Proto_Player &&
	...
	ReceiveOnHit(t, e, i, r, o, a, n, s, h, l, c) {
		if (this.kVr(forbidHitTagIds))
			this.kVr(enterFkForbidHitTagIds) &&
				this.HVr(EntitySystem_1.EntitySystem.Get(t.BulletEntityId));
		else if (
			...
			if (
				...
				if (
					...
					(this.gVr = this.oVr?.TrySwitchHitState(c, !1) ?? 0),
					!this.oVr || this.gVr)
				) {
					this.BeHitAnim = c;
					let e = (i = t.ReBulletData.Base).BeHitEffect;
					this.sVr && (e = i.HitEffectWeakness),
						(a = ConfigManager_1.ConfigManager.BulletConfig.GetBulletHitData(
							this.iVr,
							e,
						))
	...
	XVr(t) {
		...
		(e.J4n = MathUtils_1.MathUtils.NumberToLong(i)),
			(e.sVn = MathUtils_1.MathUtils.NumberToLong(r)),
			(e.ujn = Long.fromNumber(this.rVr.BulletId)),
			(i = this.rVr.HitPosition),
			(e.rWn = {
				X: i.X,
				Y: i.Y,
				Z: i.Z,
			...
			(e.uWn = this.mVr),
			(e.cWn = this.nVr),
			(e.mWn = this.rVr.HitPart?.toString() ?? ""),
			(e.dWn = !this.VVr() && this.nVr && !this.EnterFk),
			(r = t.GetBulletInfo());
		(e.X4n = r.BulletInitParams.SkillId), (e.CWn = r.BulletInitParams.Source);
		const o = this.gVr;
		o && (e.oVn = this.oVr?.GetFightState() ?? 0),
			((i = Protocol_1.Aki.Protocol.y3n.create()).gWn = e),
			this.Yea(i),
			CombatMessage_1.CombatNet.Call(15363, this.Entity, i, (t) => {
	...
	OnHitOne(t, e, i, r, o, a, n, s, h) {
		...
		this.t6r();
		this.o6r();
		this.iwr(i), this.n6r(), this.a6r(i);
	...
	OnHit(t, e, i, r, o, a, n, s, h) {
		...
		if (!0 !== ModManager_1.ModManager.Settings.GodMode || c != l)
			if (!0 !== ModManager_1.ModManager.Settings.HitMultiplier || m != l)
				this.OnHitOne(t, e, i, r, o, a, n, s, h);
			else
	...
	iwr(t) {
		...
		this.rVr.ReBulletData.TimeScale.TimeScaleOnAttackIgnoreAttacker
			...
			: 0 < i.时间膨胀时长 &&
				...
				StringUtils_1.StringUtils.IsEmpty(t) ||
					...
					(e = ModelManager_1.ModelManager.CharacterModel.GetHandle(e))?.Valid
						? e.Entity.GetComponent(109)?.SetTimeScale(
								i.优先级,
								i.时间膨胀值,
								i.时间膨胀变化曲线,
								i.时间膨胀时长,
			...
			!this.vHr ||
				...
				this.OVr(-648310348) ||
				((e = this.rVr.ReBulletData.TimeScale),
				(i = this.sVr ? e.VictimTimeScaleOnHitWeakPoint : e.TimeScaleOnHit),
	...
	iHo() {
		...
		if (e.IsPartHit) {
			...
			if (this.uVr && 0 < this.uVr.length)
				for (const o of this.uVr) {
					...
					if (r) {
						if (((a = !0), r.ReplaceBulletHitEffect))
							return t.clear(), this.m6r(t, r, i), t;
						this.m6r(t, r, i);
					}
				}
			if (
		...
		var o,
			a = (o = this.rVr.ReBulletData.Render.EffectOnHit).get(9);
	...
	p6r(t, e) {
		...
		t && 0 < t.length
			? ((i = (t = t[0]).IsWeaknessHit),
				(this.sVr ||= i),
				(i = this.v6r(e, this.sVr, !1, t.Index)),
				(this.ToughDecreaseValue = i.ToughResult))
			: ((t = this.v6r(e, this.sVr, !1)),
				(this.ToughDecreaseValue = t.ToughResult));
	}
	...
	C6r(t) {
		return (
			((t = Object.assign(t)).Attacker = this.iVr
				.GetComponent(48)
				.GetAttributeHolder()),
			(t.Target =
	...
	n6r() {
		...
		CameraController_1.CameraController.Model.IsModeEnabled(2) ||
			...
			!this.rVr.IsShaking ||
			((e = this.rVr.ReBulletData.Render),
			(t = this.sVr
	...
	a6r(t) {
		if (
			...
			(this.nVr = !1), this.kVr(enterFkForbidHitTagIds) && this.HVr(t);
		else if (this.nVr) {
			var e = this.rVr.ReBulletData.Base;
			let r = e.BeHitEffect;
			if (
				(this.sVr && (r = e.HitEffectWeakness),
				...
				if (
					...
					(this.NeedCalculateFallInjure = !0),
					!(0 < i || this.ToughDecreaseValue <= 0 || this.OVr(1447214865)) ||
						(this.IsTriggerCounterAttack && this.fVr))
				) {
					let r = 0;
					e && (r = this.fVr ? 7 : e.被击动作),
						(r = this.y6r(r)),
						this.oVr &&
						((this.gVr = this.oVr.TrySwitchHitState(r, !0)), !this.gVr)
							? this.HVr(t)
	...
	L6r(t) {
		if (
			(this.OVr(504239013) &&
				(e = this.Entity.GetComponent(163)).Valid &&
			...
			(e = this.Entity.GetComponent(162)).Valid &&
				e.MainAnimInstance &&
			...
			if (this.OVr(-1898186757)) {
				if (4 === this.BeHitAnim) {
					if (
						((i = (e = t.地面受击滞空).滞空时间 + e.到滞空点时间), this.R6r(i))
					)
						return void this.U6r(e, i);
					if (0 < t.地面受击速度.Z) return void this.P6r(t, !1);
				}
				this.A6r(t);
			} else
				(i = (e = t.空中受击滞空).滞空时间 + e.到滞空点时间),
					this.R6r(i) ? this.U6r(e, i) : this.P6r(t, !0);
	}
	U6r(t, e) {
		var i,
			r,
			o,
			a = this.Entity.GetComponent(163);
		a.Valid &&
			((i = this.Hte),
			...
			(o = this.iVr.GetComponent(3).ActorLocationProxy.Z + t.滞空高度限制) <
				this.bVr.Z && (this.bVr.Z = o),
			a.BeginWhirlpool(
				r,
				t.到滞空点时间,
				this.bVr,
	...
	P6r(t, e) {
		...
		r.Valid &&
			((i = this.Hte),
			this.BVr.FromUeVector(e ? t.空中受击速度 : t.地面受击速度),
			(e = this.EVr?.GetCurrentValue(EAttributeId.Proto_Mass) ?? 100),
			this.BVr.MultiplyEqual(100 / e),
			this.Entity.GetComponent(160).SetMoveState(
				CharacterUnifiedStateTypes_1.ECharMoveState.KnockUp,
			),
			...
			i.ActorQuatProxy.RotateVector(this.BVr, this.bVr),
			r.Active && r.SetForceFallingSpeed(this.bVr, 31862857),
	...
	A6r(t) {
		...
		0 < a &&
			...
			(this.yVr = e.SetAddMove(i, a, void 0, this.yVr, t, r, o))),
			this.ActiveStiff(n);
	}
	y6r(t) {
	...
	x6r(t) {
		...
		(this.fVr = this.B6r()),
			this.fVr && (e = this.CounterAttackInfoInternal.有弹反动作效果),
			this.b6r(t, e),
			this.q6r(e),
			this.iVr.GetComponent(3).IsAutonomousProxy && this.G6r(e),
			this.N6r(),
	...
	d6r() {
		!this.$zo ||
			...
			(this.$zo.HasBuffAuthority() &&
				...
				(this.cBe?.SetCurSkillAnIndex(this.DDa),
				this.$zo.AddBuffFromAnimNotify(
	...
	static PreHitNotify(t, e) {
		return (
			e.gWn?.cWn &&
				!e.gWn.aWn &&
				(t = t.GetComponent(47)) &&
				!t.PreSwitchRemoteFightState(e.gWn.oVn) &&
				((e.gWn.aWn = !0), (e.gWn.oVn = 0)),
			!0
		);
	}
	static HitNotify(t, e) {
		var i,
			r,
			o,
			a = MathUtils_1.MathUtils.LongToNumber(e.gWn.J4n),
			n = ModelManager_1.ModelManager.CreatureModel.GetEntity(a);
		n?.Valid
			? ((i = e.gWn.ujn
					? MathUtils_1.MathUtils.LongToBigInt(e.gWn.ujn).toString()
					: ""),
				(r = ConfigManager_1.ConfigManager.BulletConfig.GetBulletData(
					...
					? ((r = new BulletTypes_1.HitInformation(
						...
						e.gWn.nWn &&
							r.HitPosition.Set(e.gWn.nWn.X, e.gWn.nWn.Y, e.gWn.nWn.Z),
						e.gWn.mWn &&
							(r.HitPart = FNameUtil_1.FNameUtil.GetDynamicFName(e.gWn.mWn)),
						(o = WorldGlobal_1.WorldGlobal.ToUeRotator(e.gWn.uWn)),
						t
							?.GetComponent(52)
							?.ReceiveOnHit(
								r,
						...
						t?.GetComponent(52)?.VUn(n.Entity, e.gWn))
					: Log_1.Log.CheckError() &&
						Log_1.Log.Error(
							"World",
							15,
			...
			if (!StringUtils_1.StringUtils.IsNothing(t)) {
				...
				if (this.KKs.ComparePriority(e, i)) {
					...
					r &&
						...
						((r = r.toString()),
						Log_1.Log.CheckDebug() &&
							Log_1.Log.Debug("Character", 21, "OnHitMaterialAction 命中部位", [
								"Part",
								r,
							]),
