...
let CharacterDamageComponent = (CharacterDamageComponent_1 = class extends (
	...
	ProcessDamage(e, t, a) {
		if (
			...
			this.Xte.HasTag(1918148596) && 0 === t.DamageData.ImmuneType)
		)
			return {
				DamageResult: 0,
				ToughResult: 0,
		...
		var r = t.Attacker;
		0 < e.SkillId &&
			((i = r.tRr.GetSkillInfo(e.SkillId)?.SkillGenre), (e.SkillGenre = i)),
		...
		return (
			0 <= t.PartId &&
				(n = this.Entity.GetComponent(60)?.GetPartByIndex(t.PartId)),
			(r =
				(5 === e.SkillGenre
	...
	GetServerDamage(e, t, a, r) {
		...
		Log_1.Log.CheckDebug() &&
			Log_1.Log.Debug(
				...
				20,
				"伤害Request",
				["攻击方", MathUtils_1.MathUtils.LongToBigInt(n.xjn)],
				["受击方", MathUtils_1.MathUtils.LongToBigInt(n.gVn)],
				["结算id", MathUtils_1.MathUtils.LongToBigInt(n.Pjn)],
				["isBlocked", n.kjn],
				["skillLevel", n.qjn],
				["是否弹刀", n.Ojn],
				["部位Id", n.bjn],
			...
			this.$te.GetCurrentValue(
				...
				: !this.Xte.HasTag(-1112841587) &&
					...
					(this.Zbr = TimerSystem_1.TimerSystem.Delay(() => {
						this.Xte && (this.Xte.HasTag(31862857) ? this.Aqr() : this.Uqr(!1)),
							(this.Zbr = void 0);
					}, a)),
	...
	AddToughModifier(e, t) {
		this.iqr.has(e) || this.iqr.set(e, new Map()),
			(e = this.iqr.get(e)).set(t, 1 + (e.get(t) ?? 0));
	}
